...
namespace AgileBookStore.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReviewComments_Products_ProductIdProduct",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ShoppingCarts_Products_ProductIdProduct",
                        column: x => x.ProductIdProduct,
                        principalTable: "Products",
                        principalColumn: "IdProduct");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Wishlists_Products_ProductIdProduct",
                        column: x => x.ProductIdProduct,
                        principalTable: "Products",
                        principalColumn: "IdProduct");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReviewComments_ProductIdProduct",
                table: "ReviewComments",
                column: "ProductIdProduct");

            migrationBuilder.CreateIndex(
                name: "IX_ShoppingCarts_ProductIdProduct",
                table: "ShoppingCarts",
                column: "ProductIdProduct");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Wishlists_ProductIdProduct",
                table: "Wishlists",
                column: "ProductIdProduct");
